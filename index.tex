...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, breakable, titlerule=0mm, colback=white, leftrule=.75mm, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Interactive Features}, toptitle=1mm, bottomtitle=1mm, toprule=.15mm, arc=.35mm, rightrule=.15mm, opacityback=0, bottomrule=.15mm, coltitle=black, left=2mm]
...
\caption{\label{tbl-top-dev}Top 15 Development Opportunities}
...
\addlinespace
\textbf{11} & Holy Cross Korean Episcopal Church & 1 TRURO LN, FAIRFAX 22030 & FAIRFAX & FAIRFAX-CITY & 3.44 & \textcolor[HTML]{e76f52}{\textbf{52.8}} & Historic District & Tier 3: Moderate Potential\\
\textbf{12} & Aquia Church & STAFFORD 22554 & STAFFORD & STAFFORD & 1.53 & \textcolor[HTML]{e76f52}{\textbf{50.8}} & Historic District & Tier 3: Moderate Potential\\
\textbf{13} & Aquia Church & STAFFORD 22554 & STAFFORD & STAFFORD & 0.97 & \textcolor[HTML]{e76f52}{\textbf{50.6}} & None & Tier 3: Moderate Potential\\
\textbf{14} & Aquia Church & STAFFORD 22554 & STAFFORD & STAFFORD & 0.95 & \textcolor[HTML]{e76f52}{\textbf{50.6}} & None & Tier 3: Moderate Potential\\
\textbf{15} & All Saints Sharon Chapel & 3421 FRANCONIA RD, ALEXANDRIA 22310 & ALEXANDRIA & FAIRFAX & 4.39 & \textcolor[HTML]{e76f52}{\textbf{50.2}} & None & Tier 3: Moderate Potential\\
\bottomrule

\end{longtable}

\emph{Note: Properties without street addresses are identified by
congregation name and location. These parcels have valid coordinates for
mapping but lack specific addresses in county parcel records.}
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, left=2mm, breakable, colback=white, leftrule=.75mm, toprule=.15mm, rightrule=.15mm, opacityback=0, arc=.35mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, left=2mm, breakable, colback=white, leftrule=.75mm, toprule=.15mm, rightrule=.15mm, opacityback=0, arc=.35mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-warning-color-frame, left=2mm, breakable, colback=white, leftrule=.75mm, toprule=.15mm, rightrule=.15mm, opacityback=0, arc=.35mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-important-color-frame, left=2mm, breakable, colback=white, leftrule=.75mm, toprule=.15mm, rightrule=.15mm, opacityback=0, arc=.35mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, breakable, titlerule=0mm, colback=white, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Data Quality Note}, toptitle=1mm, bottomtitle=1mm, toprule=.15mm, arc=.35mm, rightrule=.15mm, opacityback=0, bottomrule=.15mm, coltitle=black, left=2mm]
...
research. Once complete, these properties can be more precisely
...
\textbf{Historic District Designation (100\% coverage)}
...
\textbf{FEMA National Risk Index (100\% coverage)}
...
Among the 104 properties: - \textbf{Very Low or Relatively Low risk}:
79\% (minimal concerns) - \textbf{Relatively Moderate risk}: 32\%
(manageable with standard precautions, -15 point penalty) -
\textbf{Relatively High risk}: 12\% (significant mitigation required,
-40 point penalty) - \textbf{Very High risk}: \textless1\% (likely
deal-breaker, -50 point penalty)
...
\subsection{Addressing Missing Property Information Through
Geocoding}\label{addressing-missing-property-information-through-geocoding}
...
\textbf{Geocoding Results:} - \textbf{Success rate}: 100\% (11/11
properties geocoded) - \textbf{Accuracy}: Medium (0.54) representing
city-center approximations - \textbf{Location}: All 11 properties
geocoded to West Point, King William County - \textbf{Congregations}:
Two congregations affected (St.~Pauls Church, St.~Johns Episcopal
Church)
...
\textbf{Land Value Estimation Method:}
...
\textbf{Coverage Achievement:} - Properties with direct assessor land
values: 89/104 (85.6\%) - Properties with estimated land values: 15/104
(14.4\%) - Total properties with usable land value data: \textbf{104/104
(100\%)}
...
\emph{Note: Missing wetland data is treated as neutral (no penalty) to
avoid penalizing properties where environmental assessment data is
unavailable.}
...
\textbf{Goldilocks Size Classification} (for opportunity
identification):
...
\emph{The goldilocks classification focuses on the \textbf{optimal 0.5-5
acre range} that balances economic viability with manageable complexity.
Properties outside this range may have value but require different
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, breakable, titlerule=0mm, colback=white, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Assessment Framework}, toptitle=1mm, bottomtitle=1mm, toprule=.15mm, arc=.35mm, rightrule=.15mm, opacityback=0, bottomrule=.15mm, coltitle=black, left=2mm]
...
This means ultimately 100 parcels were scored and ranked for development
opportuntity:
...
attendees, \textbf{39 properties (39\%) fall within the goldilocks
development range} of 0.5-5 acres with minimal constraints:
...
cluster. The Diocese's strongest opportunities, scoring in the upper
70s, are concentrated in \textbf{Winchester in the northern Shenandoah
Valley}, where two properties at St.~Paul's on the Hill Church achieved
the portfolio's highest development scores. These sites benefit from
optimal acreage (1.5-3 acres), favorable market conditions, and minimal
...
The Fredericksburg and Central Virginia regions show numerous properties
scoring in the 40-55 range, represented by medium-sized circles in
orange tones. Many of these sites have favorable acreage but receive
constraint penalties that reduce their immediate development appeal.
However, they remain viable candidates for phased development or
projects with patient capital willing to navigate historic preservation
requirements.

Geographic clustering reveals important patterns: Winchester stands
alone as the Diocese's premier development opportunity, while Northern
Virginia properties offer multiple moderate opportunities with strong
market fundamentals offset by regulatory complexity. The Fredericksburg
corridor presents larger properties that may require more sophisticated
development approaches but offer substantial long-term value.
...
This distribution is common in institutional portfolios where properties
were acquired for mission, not market value. The analysis's value lies
in identifying the needles in the haystack---the 16 high-priority and 23
moderate-priority properties that can actually deliver financial
returns---rather than pretending the entire portfolio has equal
potential.

\textbf{In short:} A median of 35 proves the methodology is honest,
makes the high-scoring properties more valuable by contrast, and
provides clear strategic guidance: focus resources where they'll succeed
rather than spreading them thin across a portfolio where most properties
...
The portfolio spans multiple counties with highly variable concentration
and development potential. Understanding the distribution requires
recognizing how two distinct metrics work together: ``High Potential''
Classification (categorical): Properties meeting physical
criteria---1.5-5 acres, minimal environmental constraints, documented
land value. This measures what's physically developable. Development
Score (0-100 numerical): Weighted assessment across six factors---size
(20\%), current use (25\%), location (20\%), financial need (15\%),
market potential (10\%), and zoning (10\%), minus constraint penalties.
This measures how attractive development would be. These metrics can
diverge significantly, revealing different types of opportunities and
challenges:
...
2 properties, 77.6 average score, 2 High Potential (100\% conversion
rate) Both properties score in the upper 70s---the portfolio's highest
These represent the Diocese's flagship development opportunities:
optimal size (1.5-3 acres), unconstrained land, strong market
fundamentals, and minimal regulatory barriers Strategic priority:
Immediate development focus for demonstration projects

Albemarle \& Fairfax Counties: Strong individual opportunities

Albemarle: 3 properties, 54.3 average, 2 High Potential Fairfax: 3
properties, 55.2 average, 2 High Potential Above-median scores with good
conversion rates These counties offer proven development candidates with
favorable market conditions offsetting some regulatory complexity
(historic districts in several cases) Strategic priority: Include in
near-term development pipeline

\textbf{Tier 2: Volume Opportunities (High Potential Count, Modest
Scores)} Fauquier County: The geographic concentration story

7 properties, 44.4 average score, 4 High Potential (57\% conversion
rate) Holds 25\% of all High Potential properties in the portfolio (4 of
16) The divergence tells the story: These properties have the right
physical characteristics (good acreage, unconstrained) but face market
and location limitations (rural setting, lower walkability scores,
modest income growth) This is classic ``goldilocks acreage in a
challenging market'' Strategic priority: Portfolio-scale development
approach---multiple properties that could support coordinated affordable
housing or creative mixed-use projects with patient capital

Fairfax-City: Urban properties with modest outcomes

3 properties, 46.2 average score, 2 High Potential The moderate scores
despite good market fundamentals suggest regulatory complexity (likely
historic districts) or current use challenges (active church buildings
rather than parking lots) Strategic priority: Medium-term development
requiring sophisticated partners comfortable with urban regulatory
environments

\textbf{Tier 3: The King William Challenge (High Volume, Low Potential)}
King William County: The inverse of Fauquier

19 properties, 30.5 average score, 0 High Potential Contains 18\% of all
portfolio parcels but contributes zero development opportunities Why the
divergence? These properties fail the physical threshold: likely
dominated by small parcels under 0.5 acres (including the 11 properties
requiring geocoding) and possibly some oversized parcels above 5 acres
Even properties that might score modestly on market or use factors are
disqualified by size constraints before reaching the scoring phase This
represents legacy holdings---land accumulated through historical
donations and gifts that don't align with modern development economics
Strategic priority: Consider disposition, conservation easements, or
alternative mission uses (community gardens, land banks) rather than
pursuing development

\textbf{Tier 4: Limited Engagement Counties} Richmond, Fluvanna, and
others: Single properties with mixed potential

Richmond: 7 properties, 23.2 average, 1 High Potential---urban location
but mostly size-constrained small parcels Stafford, Loudoun, Page: 1
High Potential each with modest average scores (38-44 range) These
counties offer opportunistic development where individual properties
merit attention but don't justify significant resource concentration
Strategic priority: Evaluate individually as opportunities arise; don't
force development

Key Strategic Insights: 1. Geographic concentration matters differently
than expected

King William's 19 properties don't equal opportunity---they equal legacy
management challenge Fauquier's 4 High Potential properties in one
county enable economies of scale in development planning, partner
recruitment, and regulatory engagement
...
\tightlist
\item
  The metrics reveal different barriers
\end{enumerate}

High Potential count = physical development capacity (do we have the
right-sized land?) Average score = market/location/use factors (will
development actually work here?) Counties with high counts but low
scores (Fauquier) need creative approaches to overcome market
limitations Counties with zero high potential (King William) face
fundamental size constraints no amount of market improvement can fix
...
\tightlist
\item
  Resource allocation follows quality, not quantity
\end{enumerate}

Frederick County (2 parcels) deserves more attention than King William
County (19 parcels) Focus development capital on Fauquier's 4 properties
as a coordinated portfolio rather than spreading resources across single
...
\tightlist
\item
  Multiple parcels ≠ multiple opportunities
\end{enumerate}

Many parcels serve single congregations (particularly in King William)
The 104 total parcels overstate discrete development sites---true
opportunity count is closer to 39 goldilocks properties across fewer
than 20 congregational sites
...
\emph{Note: ``High Potential'' indicates properties meeting size
criteria (1.5-5 acres) and minimal constraints. Average Score reflects
broader market and location factors. Counties with high counts but lower
scores have developable land facing market or location challenges.}
...
\caption{\label{tbl-high-potential}Top Development Potential Properties}
...
Congregations flagged as `Financial Need' may still report substantial
annual giving, but their attendance and/or pledge revenue have declined
significantly since 2014. These congregations are not in crisis
today---but without intervention, they face an unsustainable path.
Development partnerships offer an opportunity to stabilize finances
while congregations remain viable, rather than waiting until resources
are exhausted
...
\midrule
KING-WILLIAM & 15 & 16 & 6.5 & 30.1\\
STAFFORD & 8 & 15 & 6.0 & 42.7\\
FAUQUIER & 7 & 22 & 8.8 & 44.4\\
FLUVANNA & 7 & 8 & 3.4 & 42.9\\
RICHMOND & 7 & 7 & 2.9 & 23.2\\
\addlinespace
WESTMORELAND & 7 & 7 & 2.6 & 21.0\\
CAROLINE & 5 & 2 & 0.8 & 21.1\\
CLARKE & 5 & 3 & 1.0 & 25.0\\
KING-GEORGE & 5 & 77 & 31.2 & 29.3\\
ALBEMARLE & 3 & 13 & 5.1 & 54.3\\
\addlinespace
CULPEPER & 3 & 18 & 7.2 & 39.7\\
FAIRFAX & 3 & 12 & 4.7 & 55.2\\
FAIRFAX-CITY & 3 & 8 & 3.3 & 46.2\\
ROCKINGHAM & 3 & 9 & 3.8 & 41.3\\
SHENANDOAH & 3 & 2 & 0.7 & 22.4\\
\addlinespace
ESSEX & 2 & 5 & 1.9 & 4.4\\
FREDERICK & 2 & 5 & 2.0 & 77.6\\
LOUDOUN & 2 & 3 & 1.3 & 38.2\\
MADISON & 2 & 1 & 0.4 & 30.6\\
PAGE & 2 & 2 & 0.9 & 44.2\\
\addlinespace
RICHMOND-CITY & 2 & 2 & 0.8 & 55.8\\
ALEXANDRIA & 1 & 0 & 0.1 & 26.5\\
ARLINGTON & 1 & 0 & 0.1 & 50.2\\
GOOCHLAND & 1 & 9 & 3.8 & 45.5\\
HANOVER & 1 & 1 & 0.6 & 54.3\\
\bottomrule
\end{longtable*}
...
\caption{\label{tab:developable-summary}Developable Properties by Congregation (Score ≥50)}\\
\toprule
...
\addlinespace
\cellcolor[HTML]{e9ab3f}{Grace Church Emmanuel Parish} & \cellcolor[HTML]{e9ab3f}{3} & \cellcolor[HTML]{e9ab3f}{14.74} & \cellcolor[HTML]{e9ab3f}{\$536,900} & \cellcolor[HTML]{e9ab3f}{14} & \cellcolor[HTML]{e9ab3f}{38} & \cellcolor[HTML]{e9ab3f}{57.2}\\
...
\cellcolor[HTML]{e9ab3f}{Calvary Episcopal Church} & \cellcolor[HTML]{e9ab3f}{1} & \cellcolor[HTML]{e9ab3f}{1.45} & \cellcolor[HTML]{e9ab3f}{\$83,300} & \cellcolor[HTML]{e9ab3f}{23} & \cellcolor[HTML]{e9ab3f}{98} & \cellcolor[HTML]{e9ab3f}{54.3}\\
\cellcolor[HTML]{e9ab3f}{St John the Baptist Church} & \cellcolor[HTML]{e9ab3f}{1} & \cellcolor[HTML]{e9ab3f}{7.10} & \cellcolor[HTML]{e9ab3f}{\$378,100} & \cellcolor[HTML]{e9ab3f}{18} & \cellcolor[HTML]{e9ab3f}{44} & \cellcolor[HTML]{e9ab3f}{53.6}\\
\cellcolor[HTML]{e9ab3f}{Holy Cross Korean Episcopal Church} & \cellcolor[HTML]{e9ab3f}{1} & \cellcolor[HTML]{e9ab3f}{3.44} & \cellcolor[HTML]{e9ab3f}{\$2,543,600} & \cellcolor[HTML]{e9ab3f}{25} & \cellcolor[HTML]{e9ab3f}{34} & \cellcolor[HTML]{e9ab3f}{52.8}\\
\addlinespace
\cellcolor[HTML]{e9ab3f}{Aquia Church} & \cellcolor[HTML]{e9ab3f}{5} & \cellcolor[HTML]{e9ab3f}{4.86} & \cellcolor[HTML]{e9ab3f}{\$145,400} & \cellcolor[HTML]{e9ab3f}{0} & \cellcolor[HTML]{e9ab3f}{1136} & \cellcolor[HTML]{e9ab3f}{52.4}\\
\cellcolor[HTML]{e9ab3f}{All Saints Sharon Chapel} & \cellcolor[HTML]{e9ab3f}{1} & \cellcolor[HTML]{e9ab3f}{4.39} & \cellcolor[HTML]{e9ab3f}{\$966,000} & \cellcolor[HTML]{e9ab3f}{28} & \cellcolor[HTML]{e9ab3f}{55} & \cellcolor[HTML]{e9ab3f}{50.2}\\
\cellcolor[HTML]{e9ab3f}{St Johns Episcopal Church} & \cellcolor[HTML]{e9ab3f}{1} & \cellcolor[HTML]{e9ab3f}{0.28} & \cellcolor[HTML]{e9ab3f}{\$714,700} & \cellcolor[HTML]{e9ab3f}{21} & \cellcolor[HTML]{e9ab3f}{29} & \cellcolor[HTML]{e9ab3f}{50.2}\\
\bottomrule
\end{longtabu}

Looking at top developent parcels and their congregations reveals a
striking pattern: all 14 congregations with development scores at or
above 50 report average attendance below 30, with a median attendance of
just 14. This universally low attendance suggests these properties
represent not just real estate opportunities, but potential candidates
for congregational transition---whether through relocation, merger, or
strategic closure.
...
congregational life while freeing underutilized property for
development. Together, these three sites represent over 13 acres and
\$4.7 million in assessed value.

Grace Church Emmanuel Parish in Fauquier County holds the largest land
portfolio among developable congregations---14.7 acres across 3
parcels---but averages only 14 in attendance with 38 members. As a
multi-parcel congregation, Grace Church may be open to consolidating its
footprint, potentially releasing surplus land for development while
maintaining a right-sized worship presence.

Aquia Church in Stafford County presents an unusual case: 1,136 members
but zero average attendance across 5 parcels. This discrepancy warrants
immediate VEREP engagement to understand the congregation's actual
status and whether the membership figure reflects historical rolls
rather than current participation.
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, breakable, titlerule=0mm, colback=white, leftrule=.75mm, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{📋 Multi-Parcel Opportunity}, toptitle=1mm, bottomtitle=1mm, toprule=.15mm, arc=.35mm, rightrule=.15mm, opacityback=0, bottomrule=.15mm, coltitle=black, left=2mm]
...
\addcontentsline{toc}{section}{2. Good Shepherd-of-the-Hills}

\markright{2. Good Shepherd-of-the-Hills}
...
\section*{3. Grace Church Emmanuel
Parish}\label{grace-church-emmanuel-parish}
\addcontentsline{toc}{section}{3. Grace Church Emmanuel Parish}

\markright{3. Grace Church Emmanuel Parish}
...
\section*{4. St Georges Church}\label{st-georges-church}
\addcontentsline{toc}{section}{4. St Georges Church}

\markright{4. St Georges Church}
...
\section*{5. Aquia Church}\label{aquia-church}
\addcontentsline{toc}{section}{5. Aquia Church}

\markright{5. Aquia Church}

\textbf{📍 STAFFORD, STAFFORD County}

{Dev Score: 50.8} {1 Parcel}
...
\textbf{⛪ Congregation:} Aquia Church
...
This congregation reports no regular attendance despite having 1136
members on the rolls. This may indicate:
...
Total Assessed Value & \$100 \\
Mean Dev Score & 50.8 \\
Walkability Score & 6.8/20 \\
Location & STAFFORD, STAFFORD \\
\end{longtable}

\textbf{Parcel ID(s):} \texttt{21\ \ \ \ \ \ \ \ 48A}
...
\section*{6. All Saints Sharon Chapel}\label{all-saints-sharon-chapel}
\addcontentsline{toc}{section}{6. All Saints Sharon Chapel}

\markright{6. All Saints Sharon Chapel}

\textbf{📍 ALEXANDRIA, FAIRFAX County}

{Dev Score: 49.2} {2 Parcels}
...
This congregation owns \textbf{2 parcels} totaling \textbf{6.06 acres},
which may present consolidation or phased development opportunities.

\end{tcolorbox}

\textbf{⛪ Congregation:} All Saints Sharon Chapel

\textbf{👥 Members:} 55

\textbf{💰 Avg Pledge:} \$82,541

\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, breakable, titlerule=0mm, colback=white, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{🚶 Moderate Walkability}, toptitle=1mm, bottomtitle=1mm, toprule=.15mm, arc=.35mm, rightrule=.15mm, opacityback=0, bottomrule=.15mm, coltitle=black, left=2mm]

This site scores \textbf{11/20} on walkability. Some transit access may
...
28 average attendees with 55 members.

\subsubsection{Financial Trend}\label{financial-trend-5}

\emph{Financial data not available.}
...
\endlastfoot
Total Parcels & 2 \\
Total Acreage & 6.06 acres \\
Total Assessed Value & \$1,009,000 \\
Mean Dev Score & 49.2 \\
Max Dev Score & 50.2 \\
Walkability Score & 11/20 \\
Location & ALEXANDRIA, FAIRFAX \\
\end{longtable}

\textbf{Parcel ID(s):} \texttt{0822\ 01\ \ 0049,\ 0824\ 01\ \ 0040}
...
\textbf{🎯 Why Engage:} Multi-parcel portfolio enables phased or
consolidated development strategy
...
\section*{7. North Farnham Parish
Church}\label{north-farnham-parish-church}
\addcontentsline{toc}{section}{7. North Farnham Parish Church}

\markright{7. North Farnham Parish Church}

\textbf{📍 FARNHAM, RICHMOND County}

{Dev Score: 47.5} {1 Parcel}
...
\textbf{⛪ Congregation:} North Farnham Parish Church

\textbf{👥 Members:} 35

\textbf{💰 Avg Pledge:} \$46,355
...
29 average attendees with 35 members.
...
Total Assessed Value & \$26,150 \\
Mean Dev Score & 47.5 \\
Walkability Score & 2/20 \\
Location & FARNHAM, RICHMOND \\
\end{longtable}

\textbf{Parcel ID(s):} \texttt{32-136}

\subsection{VEREP Action}

\textbf{🎯 Why Engage:} High development potential based on site
characteristics
...
\section*{8. Holy Cross Church}\label{holy-cross-church}
\addcontentsline{toc}{section}{8. Holy Cross Church}

\markright{8. Holy Cross Church}

\textbf{📍 AFTON, ALBEMARLE County}

{Dev Score: 46.1} {1 Parcel}
...
\textbf{⛪ Congregation:} Holy Cross Church

\textbf{👥 Members:} 36

\textbf{💰 Avg Pledge:} \$61,900

\subsection{Congregational Health}

\subsubsection{Attendance Status}\label{attendance-status-7}

\textbf{✓ Active Congregation}

28 average attendees with 36 members.

\subsubsection{Financial Trend}\label{financial-trend-7}
...
\endlastfoot
Total Parcels & 1 \\
Total Acreage & 2.36 acres \\
Total Assessed Value & \$136,000 \\
Mean Dev Score & 46.1 \\
Walkability Score & 5.8/20 \\
Location & AFTON, ALBEMARLE \\
\end{longtable}

\textbf{Parcel ID(s):} \texttt{08400000006100}
...
\subsubsection{Suggested Next Steps}\label{suggested-next-steps-7}
...
\subsubsection{Key Contacts to
Identify}\label{key-contacts-to-identify-7}
...
\section*{9. Holy Cross Korean Episcopal
Church}\label{holy-cross-korean-episcopal-church}
\addcontentsline{toc}{section}{9. Holy Cross Korean Episcopal Church}

\markright{9. Holy Cross Korean Episcopal Church}

\textbf{📍 FAIRFAX, FAIRFAX-CITY County}

{Dev Score: 45.3} {2 Parcels}
...
This congregation owns \textbf{2 parcels} totaling \textbf{7.55 acres},
which may present consolidation or phased development opportunities.

\end{tcolorbox}

\textbf{⛪ Congregation:} Holy Cross Korean Episcopal Church

\textbf{👥 Members:} 34

\textbf{💰 Avg Pledge:} \$57,025

\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, breakable, titlerule=0mm, colback=white, leftrule=.75mm, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{🚶 Highly Walkable Location}, toptitle=1mm, bottomtitle=1mm, toprule=.15mm, arc=.35mm, rightrule=.15mm, opacityback=0, bottomrule=.15mm, coltitle=black, left=2mm]

This site scores \textbf{16.3/20} on walkability, supporting car-light
households and potentially qualifying for reduced parking requirements
in development.
...
\subsubsection{Attendance Status}\label{attendance-status-8}

\textbf{✓ Active Congregation}

25 average attendees with 34 members.

\subsubsection{Financial Trend}\label{financial-trend-8}

\textbf{💰 Positive Trend}

Plate \& pledge has increased by \textbf{42\%} over the past decade.
...
\endlastfoot
Total Parcels & 2 \\
Total Acreage & 7.55 acres \\
Total Assessed Value & \$6,110,900 \\
Mean Dev Score & 45.3 \\
Max Dev Score & 52.8 \\
Walkability Score & 16.3/20 \\
Location & FAIRFAX, FAIRFAX-CITY \\
\end{longtable}

\textbf{Parcel ID(s):}
\texttt{57\ 2\ 02\ \ \ \ 157,\ 57\ 2\ 02\ \ \ \ 162A1}
...
\subsubsection{Suggested Next Steps}\label{suggested-next-steps-8}
...
\subsubsection{Key Contacts to
Identify}\label{key-contacts-to-identify-8}
...
\section*{10. St Peters Church}\label{st-peters-church}
\addcontentsline{toc}{section}{10. St Peters Church}

\markright{10. St Peters Church}

\textbf{📍 PURCELLVILLE, LOUDOUN County}

{Dev Score: 39.5} {1 Parcel}
...
\textbf{⛪ Congregation:} St Peters Church
...
\subsubsection{Attendance Status}\label{attendance-status-9}

\textbf{⚠️ Zero Average Attendance}

This congregation reports no regular attendance despite having 166
members on the rolls. This may indicate:
...
\subsubsection{Financial Trend}\label{financial-trend-9}
...
\endlastfoot
Total Parcels & 1 \\
Total Acreage & 2.02 acres \\
Total Assessed Value & \$791,900 \\
Mean Dev Score & 39.5 \\
Walkability Score & 8.5/20 \\
Location & PURCELLVILLE, LOUDOUN \\
\end{longtable}

\textbf{Parcel ID(s):} \texttt{489452448000}
...
\subsubsection{Suggested Next Steps}\label{suggested-next-steps-9}
...
\subsubsection{Key Contacts to
Identify}\label{key-contacts-to-identify-9}
...
\href{https://mted.shinyapps.io/shiny-app/?tab=adu}{\textbf{launch the
ADU Placement Dashboard}}
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, breakable, titlerule=0mm, colback=white, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Technical Methodology}, toptitle=1mm, bottomtitle=1mm, toprule=.15mm, arc=.35mm, rightrule=.15mm, opacityback=0, bottomrule=.15mm, coltitle=black, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, breakable, titlerule=0mm, colback=white, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Data Processing Notes}, toptitle=1mm, bottomtitle=1mm, toprule=.15mm, arc=.35mm, rightrule=.15mm, opacityback=0, bottomrule=.15mm, coltitle=black, left=2mm]
