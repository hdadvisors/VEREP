...
**Historic District Designation (100% coverage)**
...
**FEMA National Risk Index (100% coverage)**
...
### Addressing Missing Property Information Through Geocoding
...
missing_comparison |>
  ...
  labs(
    ...
    subtitle = "Original gaps vs. after historic districts, hazard data, estimation, and geocoding",
    x = "",
    y = "Number of Properties"
  ) +
  theme_minimal(base_size = 12) +
...
enhancement_summary <- missing_comparison |>
  ...
  mutate(
    Enhancement = case_when(
      data_type == "Wetland Data" ~ "Historic districts + FEMA NRI",
      data_type == "Land Value" ~ "Median home value estimation",
