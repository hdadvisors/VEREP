...
cat(":::\n")
```
This distribution is common in institutional portfolios where properties were acquired for mission, not market value. The analysis's value lies in identifying the needles in the haystack—the 16 high-priority and 23 moderate-priority properties that can actually deliver financial returns—rather than pretending the entire portfolio has equal potential.

**In short:** A median of 35 proves the methodology is honest, makes the high-scoring properties more valuable by contrast, and provides clear strategic guidance: focus resources where they'll succeed rather than spreading them thin across a portfolio where most properties face fundamental limitations.
...
2 properties, 77.6 average score, 2 High Potential (100% conversion rate)
Both properties score in the upper 70s—the portfolio's highest
These represent the Diocese's flagship development opportunities: optimal size (1.5-3 acres), unconstrained land, strong market fundamentals, and minimal regulatory barriers
Strategic priority: Immediate development focus for demonstration projects

Albemarle & Fairfax Counties: Strong individual opportunities

Albemarle: 3 properties, 54.3 average, 2 High Potential
Fairfax: 3 properties, 55.2 average, 2 High Potential
Above-median scores with good conversion rates
...
Strategic priority: Include in near-term development pipeline


**Tier 2: Volume Opportunities (High Potential Count, Modest Scores)**
Fauquier County: The geographic concentration story

7 properties, 44.4 average score, 4 High Potential (57% conversion rate)
Holds 25% of all High Potential properties in the portfolio (4 of 16)
...
This is classic "goldilocks acreage in a challenging market"
Strategic priority: Portfolio-scale development approach—multiple properties that could support coordinated affordable housing or creative mixed-use projects with patient capital

Fairfax-City: Urban properties with modest outcomes

3 properties, 46.2 average score, 2 High Potential
The moderate scores despite good market fundamentals suggest regulatory complexity (likely historic districts) or current use challenges (active church buildings rather than parking lots)
Strategic priority: Medium-term development requiring sophisticated partners comfortable with urban regulatory environments


**Tier 3: The King William Challenge (High Volume, Low Potential)**
King William County: The inverse of Fauquier

19 properties, 30.5 average score, 0 High Potential
...
Even properties that might score modestly on market or use factors are disqualified by size constraints before reaching the scoring phase
This represents legacy holdings—land accumulated through historical donations and gifts that don't align with modern development economics
Strategic priority: Consider disposition, conservation easements, or alternative mission uses (community gardens, land banks) rather than pursuing development


**Tier 4: Limited Engagement Counties**
Richmond, Fluvanna, and others: Single properties with mixed potential

Richmond: 7 properties, 23.2 average, 1 High Potential—urban location but mostly size-constrained small parcels
Stafford, Loudoun, Page: 1 High Potential each with modest average scores (38-44 range)
These counties offer opportunistic development where individual properties merit attention but don't justify significant resource concentration
Strategic priority: Evaluate individually as opportunities arise; don't force development
