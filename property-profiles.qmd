...
create_property_profile <- function(rank_num) {
  property <- top_parcels |> filter(rank == rank_num)
  
  if(nrow(property) == 0) return(NULL)
  
  cat("\n\n## Property #", rank_num, " {.unnumbered}\n\n", sep = "")
  cat("### ", property$sadd, "\n", sep = "")
  cat("**", property$scity, ", ", property$scounty, " County**\n\n", sep = "")
  ...
  cat("**", property$development_potential, "**\n", sep = "")
  cat(":::\n\n")
  ...
  cat("::: {}\n**", round(property$walkability_score, 1), "/20**  \n", sep = "")
  cat("Walkability\n:::\n")
  ...
  if(!is.na(property$congregation_name)) {
    cat("\n#### Congregation: ", property$congregation_name, "\n\n", sep = "")
  ...
  if(!is.na(property$walkability_score) && property$walkability_score >= 15) {
    cat("🚶 **Highly walkable location:** Supports car-light households and may qualify for reduced parking requirements\n\n")
  } else if(!is.na(property$walkability_score) && property$walkability_score >= 10) {
    cat("🚶 **Moderate walkability:** Some transit access supports density considerations\n\n")
  }
