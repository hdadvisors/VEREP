...
One of the challenges revealed through CGS' original analysis was that many congregations share properties or do not accurately record their permanent address. 

```{r data-quality-stats, echo=FALSE, results='asis'}
...
if(no_coords_count > 0) {
  ...
  cat("**", no_coords_count, "** properties have neither valid addresses nor coordinates. These require manual lookup using county tax records.\n", sep = "")
  cat(":::\n")
}
```
...
Beyond address matching, some properties were missing critical property and environmental data necessary for full development analysis.
