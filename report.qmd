...
One of the challenges revealed through CGS' original analysis was that many congregations share properties or do not accurately record their permanent address. Therefore, some of the data used in this analysis had these problems, which we attempted to sort and organize for future manual review. 
...
These congregations have properties without proper street addresses, making them difficult to verify or inspect for development. Luckily, some have coordinates, which can be verified with county tax records. 
