...
The following congregations comprise the 19 "properties" without proper street addresses, making them difficult to verify or inspect for development. 3 of these congregations (comprising X of the total 19) had coordinates, which allowed for reverse geocoding to identify the likely address or zip code. 
