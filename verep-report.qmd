...
```{r image-grid, echo=FALSE, results='asis'}
cat('<div style="margin: 40px 0;">',
    '<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px;">',
    '<img src="./images/1.png" style="width: 100%; height: 300px; object-fit: cover; border-radius: 8px;">',
    '<img src="./images/2.png" style="width: 100%; height: 300px; object-fit: cover; border-radius: 8px;">',
    '<img src="./images/3.png" style="width: 100%; height: 300px; object-fit: cover; border-radius: 8px;">',
    '<img src="./images/4.png" style="width: 100%; height: 300px; object-fit: cover; border-radius: 8px;">',
    '<img src="./images/5.jpeg" style="width: 100%; height: 300px; object-fit: cover; border-radius: 8px;">',
    '</div></div>')
```
